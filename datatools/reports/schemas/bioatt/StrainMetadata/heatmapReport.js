...
function render(queryConfig, div) {
    ...
    varDiv = jsDiv.append("div");
    plotDiv = jsDiv.append("div");
...
function onSuccess(data) {
    ...
    query_results = data;
    // Get Column Names
    columns = query_results.metaData.fields.map(function(a) {
        return a.fieldKey;
    });
...
function onFailure(errorInfo, options, responseObj)
{
    if (errorInfo && errorInfo.exception) {
        jsDiv.innerHTML = "Failure: " + errorInfo.exception;
    } else {
        jsDiv.innerHTML = "Failure: " + responseObj.statusText;
    }
}
